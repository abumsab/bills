...
/**
 * BoughtproductsFixture
 *
 */
class BoughtproductsFixture extends TestFixture
{
    ...
    public $fields = [
        'buyingbill_id' => ['type' => 'biginteger', 'length' => 20, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['buyingbill_id', 'product_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
